...
export const testimoniosEstaticos: Testimonio[] = [
  ...
  { nombre: 'Sofía Ramírez',    rol: 'Socia Directora',    empresa: 'Nexo Legal',     fila: 2, orden: 4, iniciales: 'SR', color: 'linear-gradient(135deg,#EDE9FE,#7C3AED)', texto: 'Profesionalismo, creatividad y resultados reales. Alma es la agencia que todo negocio necesita. Nuestro sitio web ahora genera consultas todos los días.' },
  { nombre: 'Laura Díaz',       rol: 'Propietaria',        empresa: 'Bloom Spa',      fila: 2, orden: 5, iniciales: 'LD', color: 'linear-gradient(135deg,#4A0E8F,#7E22CE)', texto: 'Nuestro spa nunca había tenido tanta visibilidad digital. El contenido que crea Alma es hermoso y profesional. Las reservas online aumentaron un 60%.' },
