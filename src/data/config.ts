...
export const testimoniosEstaticos: Testimonio[] = [
  ...
  { nombre: 'Laura Díaz',       rol: 'Propietaria',        empresa: 'Bloom Spa',      fila: 2, orden: 5, iniciales: 'LD', color: 'linear-gradient(135deg,#FCE7F3,#DB2777)', texto: 'Nuestro spa nunca había tenido tanta visibilidad digital. El contenido que crea Alma es hermoso y profesional. Las reservas online aumentaron un 60%.' },
