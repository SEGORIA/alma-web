...
const ESTADOS: { key: CuentaCobro['estado']; label: string; color: string }[] = [
  ...
  { key: 'enviada',   label: 'Enviada',   color: '#60A5FA' },
                  ...
                  return (
                    <div key={c._id} style={{ background: DIM, border: `0.5px solid ${isVencida ? ROSE : BDR}`, borderRadius: '6px', padding: '14px 18px', display: 'flex', alignItems: 'center', gap: '14px', flexWrap: 'wrap', borderLeft: `2.5px solid ${col}` }}>
                      ...
                      <div style={{ display: 'flex', gap: '6px', flexShrink: 0, flexWrap: 'wrap' }}>
                        <select value={c.estado} onChange={e => changeEstado(c._id!, e.target.value as CuentaCobro['estado'])} style={{ padding: '5px 8px', borderRadius: '3px', border: `0.5px solid ${BDR2}`, background: '#1A1A22', color: MUT, fontSize: '10px', cursor: 'pointer', outline: 'none' }}>
